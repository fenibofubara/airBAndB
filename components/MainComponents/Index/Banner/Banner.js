...
const Banner = () => {
    ...
    <div className="h-screen bg-opacity-50 bg-black flex items-center justify-center">
			<div className="mx-2 text-center pt-40">
           ...
           <button className="p-2  my-5 px-16 mx-2 bg-transparent border-2 bg-brandGreen bg-opacity-75 hover:bg-opacity-100 border-brandGreen rounded hover:shadow-inner font-bold text-white shadow-md transition duration-500 md:text-lg"><Link href='register'>Start Now</Link></button>
           </div>
        </div>
    </div>
